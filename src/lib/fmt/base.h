...
#define FMT_UNICODE 1
    ...
    constexpr FMT_ALWAYS_INLINE auto narrow(const char *s) -> const char * { return s; }
...
#define FMT_TYPE_CONSTANT(Type, constant)                                                                                                            \
    ...
    template<typename Char>
    FMT_CONSTEXPR auto parse_precision(const Char *begin, const Char *end, format_specs &specs, arg_ref<Char> &precision_ref,
