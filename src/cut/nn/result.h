 ...
 */
static inline int NNResult_IsSuccess(NNResult result) { return result.value >= 0; }
 ...
 */
static inline int NNResult_IsFailure(NNResult result) { return result.value < 0; }
...
namespace nn
{
    ...
    */
        ...
        bool IsLegacy() const { return ((mValue >> 27) & 0x3) == SIGNATURE_IS_LEGACY; }

        unsigned GetDescription() const { return mValue & (IsLegacy() ? 0x3FF : 0xFFFFF); }
        ...
        unsigned GetModule() const { return (mValue >> 20) & (IsLegacy() ? 0x7F : 0x1FF); }
        ...
        bool operator==(const Result &other) const { return mValue == other.mValue; }
