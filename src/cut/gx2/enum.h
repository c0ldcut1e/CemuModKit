...
CUT_ENUM_BITMASK_TYPE(GX2AttribFormat)
...
CUT_ENUM_BITMASK_TYPE(GX2ClearFlags)
...
CUT_ENUM_BITMASK_TYPE(GX2InvalidateMode)
...
CUT_ENUM_BITMASK_TYPE(GX2ScanTarget)
...
CUT_ENUM_BITMASK_TYPE(GX2SurfaceUse)
