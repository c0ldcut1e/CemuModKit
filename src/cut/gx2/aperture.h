 ...
 */
CUT_IMPORT void (*GX2AllocateTilingApertureEx)(GX2Surface *surface, uint32_t level, uint32_t depth, GX2EndianSwapMode endian,
                                               GX2ApertureHandle *outHandle, void **outAddress);
 ...
 */
CUT_IMPORT void (*GX2FreeTilingAperture)(GX2ApertureHandle handle);
