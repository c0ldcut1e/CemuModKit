...
CUT_IMPORT OSExceptionCallbackFn (*OSSetExceptionCallback)(OSExceptionType exceptionType, OSExceptionCallbackFn callback);

CUT_IMPORT OSExceptionCallbackFn (*OSSetExceptionCallbackEx)(OSExceptionMode mode, OSExceptionType exceptionType, OSExceptionCallbackFn callback);
